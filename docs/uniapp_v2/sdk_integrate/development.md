...
> [点击此处](https://www.pgyer.com/OpenIM_Uniapp)或扫描下方二维码下载

![OpenIM_Uniapp](../../images/OpenIM_Uniapp.png)



## 下载源代码

- 点击此处前往[github仓库](https://github.com/OpenIMSDK/Open-IM-Uniapp-Demo)，或复制下方命令。
...
- 重新获取AppID
  ...
  ![image-20221209192155845](../../images/config.png)

- 修改高德地图appkey (如果要使用定位功能)，应用中配置的key已绑定包名`com.tuoyun.uni`。如有需要  请自行前往高德开放平台获取。

  ![image-20221209192727819](../../images/config2.png)

  ![image-20221209192759268](../../images/config3.png)
...
- 菜单栏->发行->原生App 云打包
  ...
  ![image-20221209185322626](../../images/build.png)

- 等待云打包完成后运行自定义调试基座到模拟器或真机。

  > 菜单栏->运行->运行到 App基座

  ![image-20221209185717429](../../images/run.png)

  ![image-20221209185815575](../../images/run2.png)
