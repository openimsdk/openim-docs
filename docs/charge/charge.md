OpenIM的SDK和服务端代码100%开源，采用[Apache-2.0 License](https://github.com/OpenIMSDK/Open-IM-Server/blob/main/LICENSE)协议，已经在github公开，任何团队和个人都可以免费使用。开发者可以选择自行部署服务端，基于SDK二次开发应用。
...
商业版本是OpenIM技术团队在100%开源的OpenIM服务端和IMSDK基础上，开发带有UI功能完整的IM产品。可以直接部署运营，也可以在此基础上二次开发。商业版本须授权，否则发起诉讼，向侵权者索赔。
商业授权是永久有效（一年内免费升级），只限于用于公司自身项目（或二次分发三次），并且只能用于合法合规项目。
特别强调：
1. 我们仅提供OpenIM源代码，不包括且以后也没有计划开发任何形式的电子钱包、红包、支付等金融属性的功能和产品，该合同提供的具体功能以附件说明为准。
2. 在合作期间，如发现开发者存在以下违法违规行为，包括但不限于：色情、赌博、诈骗、数字货币交易、危害国家安全等，视为开发者违约，我们有权拒绝为开发者继续提供售后服务且可单方面解除合同。
3. 提供10个工作日免费技术服务（包含安装指导，但不提供任何形式的安装、打包、维护服务）
