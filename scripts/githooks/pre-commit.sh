...
#
#!/usr/bin/env bash
# Copyright © 2023 OpenIMSDK.d under the Apache License, Version 2.0 (the "License");
...
# FIXME! Use GIT_FILE_SIZE_LIMIT environment variable to override the file size limit
