...
then
    printError "The branch name format is invalid. Branch names in this project must adhere to the following format: $valid_branch_regex. Valid branch names should adhere to the following format: {feature|feat|openim|hotfix|test|bug|ci|cicd|style}/name. Ensure that your branch follows the valid format (e.g., feat/name or bug/name) and try again."
